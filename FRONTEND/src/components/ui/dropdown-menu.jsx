  ...
  ({ className, sideOffset = 8, align = "end", ...props }, ref) => (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        align={align}
        className={cn(
          "z-[60] w-80 origin-[var(--radix-dropdown-menu-content-transform-origin)] rounded-lg border border-strong bg-[rgba(9,10,14,0.44)] p-2 text-ink shadow-[0_30px_80px_rgba(0,0,0,0.45),0_0_0_1px_rgba(255,59,74,0.12)_inset] backdrop-blur-[16px] backdrop-saturate-125",
